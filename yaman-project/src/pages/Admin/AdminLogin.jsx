...
const AdminLogin = () => {
  ...
  return (
    <>
      <section className="bg-primary border-blue-500 border-4">
        <ToastContainer
          position="top-center"
          autoClose={3000}
        ...
        <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0 ">
          ...
          <div className="w-full bg-white rounded-lg shadow border border-secondary md:mt-0 sm:max-w-md xl:p-0 border-blue-400">
              ...
              >
                {({
                  ...
                  >
                    ...
                    <button
                      type="submit"
                      className="w-full border rounded-lg p-2 shadow-lg hover:shadow-sm delay-150 ease-linear hover:bg-slate-100"
                    >
                      Sign in
                    </button>
                  </form>
